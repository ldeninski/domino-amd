...
(function (global) {
    ...
    var StackFrame = (function () {
        function StackFrame(stack, procName, args) {
            this.name = procName;
            this.args = args;
            stack.push(this);
        }
    ...
    var _Debug = (function () {
        ...
        _Debug.prototype.enter = function (procName, args) {
            return new StackFrame(this.callstack, procName, args);
        };
        _Debug.prototype.leave = function () {
            return this.callstack.pop();
        };
        _Debug.prototype.printStackTrace = function () {
            print("--- stack trace ---");
            for (var i = this.callstack.length - 1; i > 0; i--) {
                print(this.callstack[i].name);
            }
        };
        _Debug.prototype.log = function (msg) {
            print(msg);
        };
        _Debug.prototype.err = function (msg) {
            print(msg);
        };
        return _Debug;
    })();
